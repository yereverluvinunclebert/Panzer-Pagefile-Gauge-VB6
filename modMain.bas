...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    widgetName = "Panzer Pagefile Gauge"
...
'        gblMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", gblSettingsFile)
        ...
        ' other
        gblClockHighDpiXPos = fGetINISetting("Software\PzPagefileGauge", "clockHighDpiXPos", gblSettingsFile)
        gblClockHighDpiYPos = fGetINISetting("Software\PzPagefileGauge", "clockHighDpiYPos", gblSettingsFile)
        
        gblClockLowDpiXPos = fGetINISetting("Software\PzPagefileGauge", "clockLowDpiXPos", gblSettingsFile)
        gblClockLowDpiYPos = fGetINISetting("Software\PzPagefileGauge", "clockLowDpiYPos", gblSettingsFile)
