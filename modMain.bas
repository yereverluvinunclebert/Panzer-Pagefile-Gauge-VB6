...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    ' = "none"
    gblStartupFlg = True
    gblWidgetName = "Panzer Pagefile Gauge"
    thisPSDFullPath = App.Path & "\Res\Panzer Pagefile Gauge VB6.psd"
    ...
    menuForm.mnuAbout.Caption = "About Panzer Pagefile Gauge Cairo " & gblCodingEnvironment & " widget"
    ...
    Call readSettingsFile("Software\PzPagefileGauge", gblSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If gblFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzPagefileGauge", "firstTimeRun", gblFirstTimeRun, gblSettingsFile
    End If
...
'        gblVolumeBoost = fGetINISetting(Location, "volumeBoost", gblSettingsFile)
        ...
        ' other
        gblGaugeHighDpiXPos = fGetINISetting("Software\PzPagefileGauge", "gaugeHighDpiXPos", gblSettingsFile)
        gblGaugeHighDpiYPos = fGetINISetting("Software\PzPagefileGauge", "gaugeHighDpiYPos", gblSettingsFile)
        gblGaugeLowDpiXPos = fGetINISetting("Software\PzPagefileGauge", "gaugeLowDpiXPos", gblSettingsFile)
        gblGaugeLowDpiYPos = fGetINISetting("Software\PzPagefileGauge", "gaugeLowDpiYPos", gblSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    gblSettingsDir = fSpecialFolder(feUserAppData) & "\PzPagefileGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        gblUnhide = "true"
        sPutINISetting "Software\PzPagefileGauge", "unhide", gblUnhide, gblSettingsFile
