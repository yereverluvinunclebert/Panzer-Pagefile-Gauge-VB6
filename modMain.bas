...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzPagefileGauge", PzGSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If PzGFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzPagefileGauge", "firstTimeRun", PzGFirstTimeRun, PzGSettingsFile
    End If
...
'        PzGMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", PzGSettingsFile)
        ...
        ' other
        PzGClockHighDpiXPos = fGetINISetting("Software\PzPagefileGauge", "clockHighDpiXPos", PzGSettingsFile)
        PzGClockHighDpiYPos = fGetINISetting("Software\PzPagefileGauge", "clockHighDpiYPos", PzGSettingsFile)
        
        PzGClockLowDpiXPos = fGetINISetting("Software\PzPagefileGauge", "clockLowDpiXPos", PzGSettingsFile)
        PzGClockLowDpiYPos = fGetINISetting("Software\PzPagefileGauge", "clockLowDpiYPos", PzGSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    PzGSettingsDir = fSpecialFolder(feUserAppData) & "\PzPagefileGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        PzGUnhide = "true"
        sPutINISetting "Software\PzPagefileGauge", "unhide", PzGUnhide, PzGSettingsFile
