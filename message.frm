...
Private Sub Form_Activate()
   ...
   On Error GoTo Form_Activate_Error
    ...
    gblMessageAHeightTwips = fGetINISetting("Software\PzPagefileGauge", "messageAHeightTwips", gblSettingsFile)
    gblMessageAWidthTwips = fGetINISetting("Software\PzPagefileGauge", "messageAWidthTwips ", gblSettingsFile)
...
Private Sub Form_Resize()
    ...
    sPutINISetting "Software\PzPagefileGauge", "messageAHeightTwips", gblMessageAHeightTwips, gblSettingsFile
    sPutINISetting "Software\PzPagefileGauge", "messageAWidthTwips", gblMessageAWidthTwips, gblSettingsFile
...
Public Property Let propTitle(ByVal newValue As String)
   On Error GoTo propTitle_Error
    ...
    If mPropTitle = "" Then
        Me.Caption = "Panzer-Pagefile-Gauge-" & gblCodingEnvironment & " Message."
    Else
