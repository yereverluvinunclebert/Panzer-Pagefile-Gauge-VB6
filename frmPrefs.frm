...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzPagefileGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzPagefileGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
Private Sub chkWidgetHidden_Click()
   On Error GoTo chkWidgetHidden_Click_Error
    ...
    sPutINISetting "Software\PzPagefileGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
...
'    End If
    ...
    If PzGStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzPagefileGaugeWidget", """" & App.path & "\" & "Panzer Pagefile Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzPagefileGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzPagefileGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzPagefileGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "scrollWheelDirection", PzGScrollWheelDirection, PzGSettingsFile
                
        sPutINISetting "Software\PzPagefileGauge", "gaugeFunctions", PzGGaugeFunctions, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "pointerAnimate", PzGPointerAnimate, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "samplingInterval", PzGSamplingInterval, PzGSettingsFile
        
        
        'sPutINISetting "Software\PzPagefileGauge", "clockFaceSwitchPref", PzGClockFaceSwitchPref, PzGSettingsFile
'        sPutINISetting "Software\PzPagefileGauge", "mainGaugeTimeZone", PzGMainGaugeTimeZone, PzGSettingsFile
'        sPutINISetting "Software\PzPagefileGauge", "mainDaylightSaving", PzGMainDaylightSaving, PzGSettingsFile
        'sPutINISetting "Software\PzPagefileGauge", "secondaryGaugeTimeZone", PzGSecondaryGaugeTimeZone, PzGSettingsFile
        'sPutINISetting "Software\PzPagefileGauge", "secondaryDaylightSaving", PzGSecondaryDaylightSaving, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzPagefileGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzPagefileGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzPagefileGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzPagefileGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        
        sPutINISetting "Software\PzPagefileGauge", "clockLowDpiXPos", PzGClockLowDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzPagefileGauge", "clockLowDpiYPos", PzGClockLowDpiYPos, PzGSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(PzGMainDaylightSaving)
    ...
    txtDefaultEditor.Text = PzGDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer Pagefile Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-Pagefile-Gauge-VB6"
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Panzer-Pagefile-Gauge-VB6", vbNullString, App.path, 1)
    End If
...
'        sliAnimationInterval.ToolTipText = "Adjust to make the animation smooth or choppy. Any adjustment in the interval takes place instantly. Lower values are smoother but the smoother it runs the more Pagefile it uses."
...
'        cmbMainDaylightSaving.ToolTipText = "Select and activate Daylight Savings Time for your area."
        ...
        cmbTickSwitchPref.ToolTipText = "The movement of the hand can be set to smooth or regular flicks, the smooth movement uses slightly more Pagefile."
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    sPutINISetting "Software\PzPagefileGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
